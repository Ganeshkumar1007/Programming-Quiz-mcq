                                  ...
                                  int[] result = obj.unique(total,limit);
                                    ...
                                    int i,j;
                                        for( i=0, j=1;i<limit;i++,j++)
                                        {
                                            ...
                                            int c=result[i];
                                            PreparedStatement pst = con.prepareStatement("select question from javaquestions where id=? ");
                                             pst.setInt(1, c);
                                              ...
                                              <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 " id="pos" style="color:black">
                                               ...
                                               {
                                                   PreparedStatement dst = con.prepareStatement("select options from javaquestions where id=? and opid =? ");
                                                  dst.setInt(1, c);
                                                  dst.setInt(2, option[e]);
                                                     ResultSet ast = dst.executeQuery();  
                                                     
                                                int data = obj.fetchjava(c, option[e]);
