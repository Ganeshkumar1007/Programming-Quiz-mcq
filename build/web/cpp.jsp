...
<body>
    ...
    <div class="container-fluid" style="margin: 50px;" id ="remove">
        <div class="row" id = "head">
            <div class="col-md-12" >
<!--                <div id="d" style="color:black">
                        <label for="cars" style="margin-top: 50px">Select programming language :</label>
                        <select name="hai" id="opt" >
                       <option >choose</option>
                     <option name="c" >C++ programming</option>

                        </select>
                        <p id="h" style="color: red; visibility: hidden;">Invalid</p>
                        <button class="btn btn-success" id ="sub">Submit</button>
                </div>-->
                <form action="answercpp">
...
<!--                <script>
               ...
               <%
                                  ...
                                  int[] result = obj.unique(total,limit);
                                    ...
                                    int i,j;
                                        for( i=0, j=1;i<limit;i++,j++)
                                        {
                                            ...
                                            int c=result[i];
                                            PreparedStatement pst = con.prepareStatement("select question from cppquestions where id=? ");
                                             pst.setInt(1, c);
                                              ...
                                              <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 " id="pos" style="color:black">
                                               ...
                                               {
                                                   PreparedStatement dst = con.prepareStatement("select options from cppquestions where id=? and opid =? ");
                                                  dst.setInt(1, c);
                                                  dst.setInt(2, option[e]);
                                                     ResultSet ast = dst.executeQuery();  
                                                     
                                                int data = obj.fetchcpp(c, option[e]);
                     ...
                     %>
                     <a  style="padding-left: 50px"><button class="btn btn-success" id="submit" >Submit</button></a>
